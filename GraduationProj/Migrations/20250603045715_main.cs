    ...
    public partial class main : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingInfos", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserItems_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserItems_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserItems_Wishlists_WishlistId",
                        column: x => x.WishlistId,
                        principalTable: "Wishlists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProductDetailsRelatedProducts",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDetailsRelatedProducts", x => new { x.ProductDetailsId, x.RelatedProductsId });
                    table.ForeignKey(
                        name: "FK_ProductDetailsRelatedProducts_ProductsDetails_ProductDetailsId",
                        column: x => x.ProductDetailsId,
                        principalTable: "ProductsDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDetailsRelatedProducts_Products_RelatedProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTraits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductTraits_ProductsDetails_ProductDetailsId",
                        column: x => x.ProductDetailsId,
                        principalTable: "ProductsDetails",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_UserItems_UserItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDetailsRelatedProducts_RelatedProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTraits_ProductDetailsId",
                table: "ProductTraits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserItems_AddressId",
                table: "UserItems",
                column: "AddressId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserItems_CartId",
                table: "UserItems",
                column: "CartId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserItems_WishlistId",
                table: "UserItems",
                column: "WishlistId",
                unique: true);
        }
